...
import grayScarf from '../assets/gray-scarf.jpg'
...
const Acessories = ({image, name, description, price}) => {
  ...
  <Product image="gray-scarf.jpg" name="Šedá vlněná šála" description="Stylová unisexová šála vyrobená ze 100% extra jemné merino vlny. Moderní, jednoduché a věčné." price="970 Kč" />
